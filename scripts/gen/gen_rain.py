...
lvgl:
  pages:
    - id: page_face
      ...
      # problem: the rendered glyphs come out a hair taller than the arithmetic,
      # LVGL decides the page overflows, and a scrollbar appears down the right
      # hand side. Seen on hardware 2026-07-22. There is nothing to scroll to, so
      # the bar is pure artefact.
      scrollbar_mode: "OFF"
      widgets:
'''
