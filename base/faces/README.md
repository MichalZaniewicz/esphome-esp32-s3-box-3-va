...
| **Devil** | Horns, a flame, a very level stare | White eyes with dark plum pupils. The artwork kept the brows, the nose AND the eye shadow - two soft blocks under the brows - and that shadow is the best landmark on the face, because it is exactly where the eyes were. Her face sits right of frame centre, so the axis is 167 rather than 160. |
